...
fcell=initcell(100.0,100.0,atoms,interaction,cp=[3,3,3],Prg=[0.03,8])
...
thermostat = Thermostat(100.0, 10000.0, 0.0, 0.0)
barostat=Barostat(100.0,10000.0,fcell.Volume,0.0)
...
open("data_z.txt", "a") do io
    ...
    for i in 1:1000 
        RK3_step!(z,0.00001,tpcell,interaction,thermostat,barostat)    
