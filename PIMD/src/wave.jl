...
"""
function applyWavePerturbation!(fcell::UnitCell,interaction::AbstractInteraction,waveVector::Vector{Float64}=[0.0,0.0,0.1];bd::Vector{Vector{Int}}=[[1,1,0],[1,1,1],[1,0,0]])
    for bd0 in bd
