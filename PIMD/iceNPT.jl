...
O=Atom(invlt*[0.5, 0.5, 0.5],15.9994*amuM)
H1=Atom(invlt*[0.5+0.98343 , 0.0, 0.1],1.008*amuM)
H2=Atom(invlt*[0.5-0.15417, 0.1-0.62358, 0.0],1.008*amuM)
...
writedlm(io, [i, T, pint,cell.Volume,Ep+Ek]')
